...
The \verb|port_no| field contains the number of the port to obtain statistics about. The port number should be set to \verb|OFPP_NONE| to obtain the statistics of \emph{all} ports.
\\\\
The \verb|body| of the reply consists of an array of the following:
