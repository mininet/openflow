...
If the MSB of the \verb|vendor| field is 0, then then the low-order bytes are an IEEE Organizationally Unique Identifier (OUI), otherwise they are assigned by the OpenFlow Consortium.  The meaning of the data portion of Vendor messages is left undefined.
